...
AudioManager.prototype.start = function() {
	if(!this.currentlyPlaying) {
		if(this.queue.length) {
			...
			return this.client.voiceConnection.playRawStream(playable.stream, this.options)
			.then((intent) => {
				intent.on('end', () => {
					this.stop();
					if(this.loop) {
...
AudioManager.prototype.stop = function() {
	...
	if(this.client.voiceConnection && this.currentlyPlaying) {
...
AudioManager.prototype.play = function() {
	return this._play.apply(this, arguments).then(function(status) {
		this.start();
		return status;
	});
};
